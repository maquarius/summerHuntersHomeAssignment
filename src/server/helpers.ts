...
const PORCU = {
  ...
  backStory: `
    ...
    The city of Delareum was not too organized and it was led by scoundrels and thugs. They had planned for some while now to steal the riches of Coral Reef, and during the night they came. \n
    ...
    When he saw the destruction he vowed to have his revenge for his loved one and replenish the world from evil.
  `,
...
const LISA = {
 ...
 `,
  backStory: `
    Coming from a wealthy family of McAllisters, Lisa had a joyful childhood. Though as the day went by at helping her family with upkeeping the farm and raking leaves, she found herself quite bored. She said that to her father. Being a huntsman and the head of the family, Joe McAllister decided to teach his daughter to shoot with a revolver. After that there was no coming back.
  `,
  attributes: {
    strength: 20,
    intelligence: 40,
  ...
  skills: [
    ...
    },
    {
      ...
      element: "Fire",
      description:
        "Shoots a full 6-rounder at multiple targets, dealing 20 damage to each target."
    },
    {
      name: "Holster shot",
      damage: 25,
      element: "Physical",
      description:
        "Shoots a quick shot, drawing her gun from a holster and putting it back."
    }
  ]
};
...
const GIDEON = {
  ...
  description: `
    The laptop that he carries with him amplifies and channels his already enormous powers. Even though he might look soft and calm, there is a raging power swirling inside him. One should not get in his way.
 `,
  backStory: `
    Gideon had always been bit of an oddball. He first noticed his psychic skills when he rescued a tiny kitten from getting squashed by a car. Little did he know of his future before awakening his powers, but at that point it seemed clear to him what he had to do. Couple years after the incident he joined the Hunters.
 `,
  attributes: {
    strength: 1,
    intelligence: 99,
